	...
	<div class="container">
		<form action="" method="POST" role="form" style="margin: 0 auto;padding: 15px;" accept-charset="utf-8">
			...
			<div class="form-group">
				<label for="palabaEs" class="col-lg-2 control-label">Palabra Español<span style="color:red">*</span></label>
				<div class="col-lg-10">
				<select class="form-control" id="espaniol" name="espaniol" style="width: 26%;"  required="required" >
				...
				<label for="descripEs" class="col-lg-2 control-label">Palabra en Lengua<span style="color:red">*</span></label>
				<div class="col-lg-10">
				<select class="form-control" id="lenguapal" name="lenguapal" style="width: 26%;"  required="required" >
				  <option value="">seleccione</option>
