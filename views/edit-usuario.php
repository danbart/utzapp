	...
	<div class="container">	
		<form method="POST" id="registrous" name="registrous" role="form" style="margin: 0 auto;max-width: 490px;padding: 15px;" accept-charset="utf-8" >
			...
			<div class="form-group">
				...
				<br />
				<label for="regadmin">Administrador</label><br />	
				<div class="well well-sm">				
				<input type="radio" id="regadmin" name="regadmin" value="1"<?php if($utz_adminitrador==1){echo 'checked ';};?>> SI </div>
				<div class="well well-sm">
				<input type="radio" id="regadmin" name="regadmin" value="0"<?php if($utz_adminitrador==0){echo 'checked';};?>> NO </div><br />
				</div>
			...
			<a href="/list-usuarios" class="btn btn-primary">Cancelar</a>
		</form>
